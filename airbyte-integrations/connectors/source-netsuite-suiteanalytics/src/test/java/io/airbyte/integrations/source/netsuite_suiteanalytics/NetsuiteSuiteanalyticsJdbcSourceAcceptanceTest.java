...
class NetsuiteSuiteanalyticsJdbcSourceAcceptanceTest extends JdbcSourceAcceptanceTest {

  private static final Logger LOGGER = LoggerFactory.getLogger(NetsuiteSuiteanalyticsJdbcSourceAcceptanceTest.class);
  ...
  public AbstractJdbcSource<JDBCType> getSource() {
    return new NetsuiteSuiteanalyticsSource();
  }
  ...
  public String getDriverClass() {
    return NetsuiteSuiteanalyticsSource.DRIVER_CLASS;
  }
